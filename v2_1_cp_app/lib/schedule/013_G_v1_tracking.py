...
#     'x-cp-app-req-time': '1767976276090',
...
def run(session: requests.Session):
    url = "https://cmapi.coupang.com/modular/v1/endpoints/12530/ff/v1/featureFlag/tracking?flag=FF-Android-Branch-Marketing-Logger&timestamps=1767976275673"
    method = "GET"
