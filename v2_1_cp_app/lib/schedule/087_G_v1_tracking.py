...
# Reference Data Index: 86
# Method: GET
#
# Original Headers (Comparison):
# ------------------------------
# {
#     'x-timestamp': '1767976286799',
...
#     'x-cp-app-req-time': '1767976287884',
#     'x-view-name': '/search',
...
#     'x-signature': 'f8ae0f91f55fc3766973b539f47bfebf12d97f80cd5ad0e903dbf6b9756186cd',
...
def run(session: requests.Session):
    url = "https://cmapi.coupang.com/modular/v1/endpoints/12530/ff/v1/featureFlag/tracking?flag=SDPE-Search-GuidedSearch-Animation-Disable-On-Exposed-Filter-Selected&timestamps=1767976275673"
    method = "GET"
