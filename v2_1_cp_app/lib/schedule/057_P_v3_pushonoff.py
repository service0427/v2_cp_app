...
# Reference Data Index: 56
# Method: POST
#
# Original Headers (Comparison):
# ------------------------------
# {
#     'x-timestamp': '1767976278548',
...
def run(session: requests.Session):
    url = "https://cmapi.coupang.com/v3/events/types/pushonoff"
    method = "POST"
