...
# Reference Data Index: 102
# Method: GET
#
# Original Headers (Comparison):
# ------------------------------
# {
#     'x-timestamp': '1767976295602',
...
#     'x-cp-app-req-time': '1767976296688',
#     'x-view-name': '/search',
...
#     'x-signature': '4d64846d19c83b05d4b9e55ac37b27aa4b9cd02f6bd4d2afaf801cf675c1357b',
...
def run(session: requests.Session):
    url = "https://cmapi.coupang.com/modular/v1/endpoints/12597/v4/auto-completes?keyword=%ED%98%B8%EB%B0%95%EC%8B%9C&lastInputs=%ED%98%B8%EB%B0%95%EC%8B%9C%2C%ED%98%B8%EB%B0%97%2C%ED%98%B8%EB%B0%95%2C%ED%98%B8%EB%B0%94%2C%ED%99%89&membershipStatus=UNKNOWN"
    method = "GET"
