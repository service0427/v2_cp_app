...
# Reference Data Index: 26
# Method: GET
#
# Original Headers (Comparison):
# ------------------------------
# {
#     'x-timestamp': '1767976275437',
...
def run(session: requests.Session):
    url = "https://cmapi.coupang.com/modular/v1/endpoints/12530/ff/v1/featureFlag/tracking?flag=FF-RDS-Android-PageWidgetImpression&timestamps=1767976275673"
    method = "GET"
