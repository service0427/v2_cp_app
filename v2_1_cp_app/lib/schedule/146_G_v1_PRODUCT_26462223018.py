...
# Reference Data Index: 145
# Method: GET
#
# Original Headers (Comparison):
# ------------------------------
# {
#     'x-timestamp': '1767976315729',
...
#     'x-cp-app-req-time': '1767976316815',
#     'x-view-name': '/pdp',
...
#     'x-signature': 'acfd522b50f640596e52380451c69ef1c9dd406c0282a8d0a9a70a0fd876724c',
...
def run(session: requests.Session):
    url = "https://cmapi.coupang.com/modular/v1/pages/47/sdp-atf-ads/9024146312/26462223018?vendorItemId=93437504336&responseType=FLATTENED&sourceType=search"
    method = "GET"
