...
#     'x-cp-app-req-time': '1767976276088',
...
def run(session: requests.Session):
    url = "https://cmapi.coupang.com/modular/v1/endpoints/12530/ff/v1/featureFlag/tracking?flag=MobileStability-AOS-Core-FeatureControl&timestamps=1767976275673"
    method = "GET"
