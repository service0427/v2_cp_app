    ...
    body = [
        {
            'common': {
                ...
                'eventTime': '2026-01-10T01:31:57.077+0900',
                'memberSrl': '',
                'app': {
                    'osVersion': '15',
                    'model': 'SM-A165N',
        ...
        },
        {
            'common': {
                ...
                'market': 'KR',
                'resolution': '1080x2340',
                'eventTime': '2026-01-10T01:31:57.534+0900',
                'memberSrl': '',
                'app': {
                    'osVersion': '15',
                    'model': 'SM-A165N',
            ...
            'data': {
                ...
                'featureName': 'sdp_image_time_spent_logging',
                'schemaName': 'sdp_no_data_no_log_state',
                'additionalComment': 'No data to log'
            },
            'extra': {}
        },
        {
            'common': {
                ...
                'market': 'KR',
                'resolution': '1080x2340',
                'eventTime': '2026-01-10T01:31:57.555+0900',
                'memberSrl': '',
                'app': {
                    'osVersion': '15',
                    'model': 'SM-A165N',
            ...
            'data': {
                ...
                'logType': 'impression',
                'pageName': 'sdp',
                'eventName': 'bottom_gnb_impression',
                'domain': 'sdp',
                'exposedArea': 'Home,Category,Search,MyCoupang,Cart',
