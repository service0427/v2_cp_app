...
# Reference Data Index: 18
# Method: GET
#
# Original Headers (Comparison):
# ------------------------------
# {
#     'x-timestamp': '1767976275147',
...
def run(session: requests.Session):
    url = "https://cmapi.coupang.com/modular/v1/endpoints/11041/main-lite-config?abOptions=90573%3AA%2C95563%3AA"
    method = "GET"
