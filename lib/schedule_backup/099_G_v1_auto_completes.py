...
# Reference Data Index: 98
# Method: GET
#
# Original Headers (Comparison):
# ------------------------------
# {
#     'x-timestamp': '1767976294020',
...
#     'x-cp-app-req-time': '1767976295106',
#     'x-view-name': '/search',
...
#     'x-signature': 'e2376a9497631f82706d2112292901094343d1939eaf0369366c192fdc2cf805',
...
def run(session: requests.Session):
    url = "https://cmapi.coupang.com/modular/v1/endpoints/12597/v4/auto-completes?keyword=%ED%98%B8%EB%B0%95&lastInputs=%ED%98%B8%EB%B0%95%2C%ED%98%B8%EB%B0%94%2C%ED%99%89%2C%ED%98%B8%2C%E3%85%8E&membershipStatus=UNKNOWN"
    method = "GET"
