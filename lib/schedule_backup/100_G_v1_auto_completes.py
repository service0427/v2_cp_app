...
# Reference Data Index: 99
# Method: GET
#
# Original Headers (Comparison):
# ------------------------------
# {
#     'x-timestamp': '1767976294601',
...
#     'x-cp-app-req-time': '1767976295687',
#     'x-view-name': '/search',
...
#     'x-signature': '3e17ef94bab053ff6bfd53da397468b68de2db655eb879716c99509772d44f23',
...
def run(session: requests.Session):
    url = "https://cmapi.coupang.com/modular/v1/endpoints/12597/v4/auto-completes?keyword=%ED%98%B8%EB%B0%97&lastInputs=%ED%98%B8%EB%B0%97%2C%ED%98%B8%EB%B0%95%2C%ED%98%B8%EB%B0%94%2C%ED%99%89%2C%ED%98%B8&membershipStatus=UNKNOWN"
    method = "GET"
