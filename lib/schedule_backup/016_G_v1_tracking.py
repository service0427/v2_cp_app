...
# Reference Data Index: 15
# Method: GET
#
# Original Headers (Comparison):
# ------------------------------
# {
#     'x-timestamp': '1767976275006',
...
def run(session: requests.Session):
    url = "https://cmapi.coupang.com/modular/v1/endpoints/12530/ff/v1/featureFlag/tracking?flag=FF-Android-Auth-Bypass-AB-Tracking-In-AD-TC&timestamps=1767976275673"
    method = "GET"
