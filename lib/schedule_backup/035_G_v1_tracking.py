...
# Reference Data Index: 34
# Method: GET
#
# Original Headers (Comparison):
# ------------------------------
# {
#     'x-timestamp': '1767976275599',
...
def run(session: requests.Session):
    url = "https://cmapi.coupang.com/modular/v1/endpoints/12530/ff/v1/featureFlag/tracking?flag=FF-Android-Collect-Home-Frames&timestamps=1767976275673"
    method = "GET"
