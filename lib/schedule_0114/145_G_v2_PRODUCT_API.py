...
def run(session: requests.Session, context: dict = None):
    ...
    keyword_type = root_result.get('keywordType', 'FOOD')
    ...
    if response and response.status_code == 200:
        try:
            ...
            # Extract anything critical for next steps?
            # Usually 155_P/174_P use IDs we already have.
            # But we could extract accurate 'isRocket', 'isWow' flags here if we wanted deeper fidelity.
            pass
        except:
            pass
